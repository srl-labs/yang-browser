...
! function(a, b, c) {
  ...
  var d = function() {
      ...
      return _createClass(c, [{
        key: "log",
        value: function(a) {
          var b = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "debug",
            c = this.opt.log;
          this.opt.debug && "object" === (void 0 === c ? "undefined" : _typeof(c)) && "function" == typeof c[b] && c[b]("mark.js: " + a)
        }
      }, {
        key: "escapeStr",
        value: function(a) {
        ...
        value: function(a) {
          ...
          for (var d in b)
            if (b.hasOwnProperty(d)) {
              var e = b[d],
                f = "disabled" !== this.opt.wildcards ? this.setupWildcardsRegExp(d) : this.escapeStr(d),
                g = "disabled" !== this.opt.wildcards ? this.setupWildcardsRegExp(e) : this.escapeStr(e);
              "" !== f && "" !== g && (a = a.replace(new RegExp("(" + f + "|" + g + ")", "gm" + c), "(" + f + "|" + g + ")"))
            } return a
        }
      }, {
        ...
        value: function(a) {
          ...
          switch (e.forEach(function(a) {
            ...
            default:
              return "()(" + a + ")";
            case "complementary":
              return "()([^" + (f = "\\s" + (f || this.escapeStr("!\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~¡¿"))) + "]*" + a + "[^" + f + "]*)";
            case "exactly":
              return "(^|\\s" + f + ")(" + a + ")(?=$|\\s" + f + ")"
          }
        }
        ...
        value: function(a, b) {
          ...
          this.opt.acrossElements && (e = "wrapMatchesAcrossElements"), 0 === h ? this.opt.done(d) : function a(b) {
    ...
    e = function() {
      function a(b) {
        var c = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1],
          ...
          e = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 5e3;
        _classCallCheck(this, a), this.ctx = b, this.iframes = c, this.exclude = d, this.iframesTimeout = e
      }
      return _createClass(a, [{
        ...
        value: function() {
          var a = void 0,
            c = [];
          return a = void 0 !== this.ctx && this.ctx ? NodeList.prototype.isPrototypeOf(this.ctx) ? Array.prototype.slice.call(this.ctx) : Array.isArray(this.ctx) ? this.ctx : "string" == typeof this.ctx ? Array.prototype.slice.call(b.querySelectorAll(this.ctx)) : [this.ctx] : [], a.forEach(function(a) {
            var b = c.filter(function(b) {
              return b.contains(a)
            }).length > 0; - 1 !== c.indexOf(a) || b || c.push(a)
          }), c
        }
      }, {
        ...
        value: function(a) {
          ...
          return a.contentWindow.location.href === b && c !== b && c
        }
      }, {
        ...
        value: function(a, b, c) {
          if (a.compareDocumentPosition(c) & Node.DOCUMENT_POSITION_PRECEDING) {
            if (null === b) return !0;
            if (b.compareDocumentPosition(c) & Node.DOCUMENT_POSITION_FOLLOWING) return !0
          }
          return !1
        }
      }, {
        ...
        value: function(a, b, c, d) {
          ...
          }), this.compareNodeIframe(a, b, c) ? (!1 !== e || f ? !1 === e || f || (d[e].handled = !0) : d.push({
            val: c,
            handled: !0
          }), !0) : (!1 === e && d.push({
            val: c,
        ...
        value: function(a, b, c, d, e) {
          for (var f = this, g = this.createIterator(b, a, d), h = [], i = [], j = void 0, k = void 0;
...
! function(a, b, c) {
  "function" == typeof define && define.amd ? define(["jquery", "datatables.net", "markjs"], function(d) {
    return a(b, c, d)
  }) : "object" === ("undefined" == typeof exports ? "undefined" : _typeof(exports)) ? (require("datatables.net"), require("markjs"), a(b, c, require("jquery"))) : a(b, c, jQuery)
}(function(a, b, c) {
  var d = function() {
    function a(b, d) {
      if (_classCallCheck(this, a), "function" != typeof c.fn.mark || "function" != typeof c.fn.unmark) throw new Error("jquery.mark.js is necessary for datatables.mark.js");
      this.instance = b, this.options = "object" === ("undefined" == typeof d ? "undefined" : _typeof(d)) ? d : {}, this.intervalThreshold = 49, this.intervalMs = 300, this.initMarkListener()
    }
    return _createClass(a, [{
      key: "initMarkListener",
      value: function() {
        var a = this,
          b = "draw.dt.dth column-visibility.dt.dth column-reorder.dt.dth",
          c = null;
        this.instance.on(b, function() {
          var b = a.instance.rows({
            filter: "applied",
            page: "current"
          }).nodes().length;
          b > a.intervalThreshold ? (clearTimeout(c), c = setTimeout(function() {
            a.mark()
          }, a.intervalMs)) : a.mark()
      ...
      value: function() {
        var a = this,
          b = this.instance.search();
        c(this.instance.table().body()).unmark(this.options), this.instance.columns({
          search: "applied",
          page: "current"
        }).nodes().each(function(d, e) {
          var f = a.instance.column(e).search(),
            g = f || b;
          g && d.forEach(function(b) {
            c(b).mark(g, a.options)
          })
        })
      }
    }]), a
  }();
  c(b).on("init.dt.dth", function(a, b) {
    if ("dt" === a.namespace) {
      var e = c.fn.dataTable.Api(b),
        f = null;
      e.init().mark ? f = e.init().mark : c.fn.dataTable.defaults.mark && (f = c.fn.dataTable.defaults.mark), null !== f && new d(e, f)
    }
  })
}, window, document);