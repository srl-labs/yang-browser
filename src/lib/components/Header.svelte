...
<!-- NAVBAR -->
<nav class="fixed top-0 z-10 px-3 py-4 w-screen select-none font-nokia-headline-light bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
	<div class="flex justify-between">
      ...
      <p class="text-gray-800 text-xs lg:text-sm dark:text-white">{model !== "nokia" ? modelTitle + " Model" : ""}</p>
		</div>
		<!-- navbar right item -->
  ...
  <aside id="sidebar" class="text-sm font-nokia-headline-light pb-4 overflow-y-auto scroll-light dark:scroll-dark z-20 w-[250px] transition-transform -translate-x-full h-screen bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700">
    <div class="px-4 space-y-4 pt-[95px] md:pt-[105px]">
      <ul class="space-y-2 text-gray-800 dark:text-gray-300">
        ...
        <li>
          <a class="flex items-center px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700 hover:rounded-lg" href="/releases/{release}/tree.txt" target="_blank">
            <svg class="w-4 h-4 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 20">
        ...
        <li>
          <a class="flex items-center px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700 hover:rounded-lg" href="/releases/{release}/paths.txt" target="_blank">
            <svg class="w-4 h-4 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 20">
              <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.828 10h6.239m-6.239 4h6.239M6 1v4a1 1 0 0 1-1 1H1m14-4v16a.97.97 0 0 1-.933 1H1.933A.97.97 0 0 1 1 18V5.828a2 2 0 0 1 .586-1.414l2.828-2.828A2 2 0 0 1 5.828 1h8.239A.97.97 0 0 1 15 2Z"/>
            </svg>
            Paths
        ...
        <li>
          <a class="flex items-center px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700 hover:rounded-lg" href="https://github.com/nokia/srlinux-yang-models/tree/{release}" target="_blank">
        ...
        <li>
          <a class="flex items-center px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700 hover:rounded-lg" href="/releases/{release}/tree.html" target="_blank">
            <svg class="w-4 h-4 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 20">
              <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5v10M3 5a2 2 0 1 0 0-4 2 2 0 0 0 0 4Zm0 10a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm9-10v.4A3.6 3.6 0 0 1 8.4 9H6.61A3.6 3.6 0 0 0 3 12.605M14.458 3a2 2 0 1 1-4 0 2 2 0 0 1 4 0Z"/>
            </svg>
            Pyang Tree
        ...
        {#if other?.length}
          {#each other as entry}
            <li>
              <a data-sveltekit-reload class="flex items-center px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700 hover:rounded-lg" href="{entry.path}">
                <svg class="w-4 h-4 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 20">
